							...
							<div className="clearfix animated fadeInUp">
								<div className="tourInstructions">
									<div className="tourInner">
										...
										<p>Students will also study HTML and CSS, which are the base languages used to build your own website. They will mostly study these skills on CodeCademy.com</p>
								...
								<div className="row">
									<p className="text-center madeby">Press ("Enter") once you have finished reading.</p>
								</div>
							</div>
						</div>
					</div>
